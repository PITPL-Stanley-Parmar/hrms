...
frappe.ui.form.on('Leave Application', {
    employee: function (frm) {
        ...
        if (employee_input) {
            frappe.call({
                method: 'hrms.hr.doctype.leave_application.leave_application.get_allowed_leave_types',
					...
					frappe.confirm(
						...
						function() {
								if (frm.doc.docstatus === 1) {
									...
									frappe.call({
										method: 'hrms.hr.doctype.leave_application.leave_application.cancel_attendance_records',
										args: {
